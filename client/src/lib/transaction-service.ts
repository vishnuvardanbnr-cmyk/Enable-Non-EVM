...
const CHAIN_ID_MAP: Record<string, { evmChainId: number; type: "evm" | "solana" | "tron" | "bitcoin" }> = {
  ...
  "chain-2": { evmChainId: 0, type: "solana" },  // Solana
  "chain-3": { evmChainId: 56, type: "evm" },    // BNB Chain
  "chain-4": { evmChainId: 137, type: "evm" },   // Polygon
  "chain-5": { evmChainId: 43114, type: "evm" }, // Avalanche
  "chain-6": { evmChainId: 42161, type: "evm" }, // Arbitrum
  "chain-7": { evmChainId: 10, type: "evm" },    // Optimism
...
const TOKEN_CONTRACTS: Record<string, Record<string, { address: string; decimals: number }>> = {
  "USDT": {
    "chain-0": { address: "0xdAC17F958D2ee523a2206206994597C13D831ec7", decimals: 6 },
    "chain-3": { address: "0x55d398326f99059fF775485246999027B3197955", decimals: 18 },
    "chain-4": { address: "0xc2132D05D31c914a87C6611C10748AEb04B58e8F", decimals: 6 },
    "chain-6": { address: "0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9", decimals: 6 },
  },
  "USDC": {
    "chain-0": { address: "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", decimals: 6 },
    "chain-3": { address: "0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d", decimals: 18 },
    "chain-4": { address: "0x3c499c542cef5e3811e1192ce70d8cc03d5c3359", decimals: 6 },
    "chain-6": { address: "0xaf88d065e77c8cC2239327C5EDb3A432268e5831", decimals: 6 },
  },
  "WBTC": {
    "chain-0": { address: "0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599", decimals: 8 },
  },
  "LINK": {
    "chain-0": { address: "0x514910771AF9Ca656af840dff83E8264EcF986CA", decimals: 18 },
  },
  "UNI": {
    "chain-0": { address: "0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984", decimals: 18 },
  },
  "SHIB": {
    "chain-0": { address: "0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE", decimals: 18 },
  },
  "STETH": {
    "chain-0": { address: "0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84", decimals: 18 },
  },
  "AAVE": {
    "chain-0": { address: "0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9", decimals: 18 },
  },
  "MKR": {
    "chain-0": { address: "0x9f8F72aA9304c8B593d555F12eF6589cC3A579A2", decimals: 18 },
  },
  "GRT": {
    "chain-0": { address: "0xc944E90C64B2c07662A292be6244BDf05Cda44a7", decimals: 18 },
  },
  "DAI": {
    "chain-0": { address: "0x6B175474E89094C44Da98b954EedeAC495271d0F", decimals: 18 },
    "chain-3": { address: "0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3", decimals: 18 },
  },
};
